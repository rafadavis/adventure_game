...
class StartTile(MapTile):
    def intro_text(self):
        ...
        on the wall.
        You can make out for paths, each equally as dark
        and foreboding.
        """
...
class VictoryTile(MapTile):
    def intro_text(self):
        ...
        ... it grows as you get closer! It's a sunlight!
...
class EnemyTile(MapTile):
    ...
    def modify_player(self, player):
        if self.enemy.is_alive():
            ...
            print(f"Enemy does {self.enemy.damage} damage. You have {player.hp} remaining.")
